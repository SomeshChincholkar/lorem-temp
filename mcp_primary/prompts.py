...
def abbreviation_normalization_prompt(source_language: str = "en") -> str:
    ...
    This is where translation actually happens (see spec 2.3) -- the
    Extractor Agent's prompt above deliberately does NOT translate, so
    this is the single place source-language text becomes English.
    """
    translation_note = (
